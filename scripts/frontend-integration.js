 ...
 * This file demonstrates how to integrate Polygonbuilder with a web frontend
 */

// For React/Vue/Angular applications
export class PolygonbuilderClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new PolygonbuilderClient(provider, contractAddress);
