...
const contractABI = require("../artifacts/contracts/Polygonbuilder.sol/Polygonbuilder.json").abi;

program
    .name("polygonbuilder-cli")
    .description("CLI tool for Polygonbuilder smart contract")
    .version("1.0.0");
